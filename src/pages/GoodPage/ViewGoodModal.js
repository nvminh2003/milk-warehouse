...
import { Package, Building2, Thermometer, Droplets, Sun, Tag, MapPin, Layers, Box, X } from "lucide-react"
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      ...
      <div className="grid gap-6 md:gap-8 lg:grid-cols-2">
        ...
        <Card className="shadow-sm">
          <CardHeader>
            ...
            <CardContent className="space-y-6">
              ...
              <InfoRow icon={<Box className="h-4 w-4" />} label="Đơn vị đo" value={product.unitMeasureName || 'N/A'} />
              <InfoRow icon={<Layers className="h-4 w-4" />} label="Danh mục" value={product.categoryName || 'N/A'} />
              <InfoRow icon={<Tag className="h-4 w-4" />} label="Thương hiệu" value={product.brandName || 'N/A'} />
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-sm">
          ...
          <CardContent className="space-y-6">
            <div className="grid gap-4">
              <InfoRow icon={<Building2 className="h-4 w-4" />} label="Công ty" value={product.companyName || 'N/A'} />
              <InfoRow icon={<MapPin className="h-4 w-4" />} label="Địa chỉ" value={product.address || 'N/A'} />
            </div>
          </CardContent>
        </Card>
      </div>
